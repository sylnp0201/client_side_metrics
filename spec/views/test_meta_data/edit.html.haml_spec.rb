...
describe "test_meta_data/edit" do
  before(:each) do
  ...
  it "renders the edit test_meta_datum form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", test_meta_datum_path(@test_meta_datum), "post" do
